...
import (
	...
	"github.com/agas-yan/go-api-ex/models" // models package where User schema is defined
...
func createConnection() *sql.DB {
	...
	if err != nil {
		log.Fatalf("Error load port pg")
	}

	psqlInfo := fmt.Sprintf("host=%s port=%d user=%s "+
		"password=%s dbname=%s sslmode=disable",
		os.Getenv("POSTGRES_HOST"), port, os.Getenv("POSTGRES_USER"),
		os.Getenv("POSTGRES_PASS"), os.Getenv("POSTGRES_DB"))
